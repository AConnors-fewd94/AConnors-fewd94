...
// 2: Incvarrement the value of #click-num( by one for each click (eg if clicknum is 0, make it 1; it clicknum is 10, make it 11; etc.)
// 3: If the number of clicks == 5, change the background-color of <body> to red
// 4: Else if t#he number of cliks == 10, change the background-color of <body> to green
